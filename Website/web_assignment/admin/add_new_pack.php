...
<div class="container-fluid">
    ...
    <?php echo $img_listi; ?>
		<!--<div class="carousel-item active">
		  <img class="d-block w-100" src="im2.jpg" alt="Decorations">
	  ...
	  <div class="carousel-item">
		<img class="d-block w-100" src="im4.jpg" alt="Photography">
	  <div class="carousel-caption">
		<button class="addimg color"><i class="fa fa-plus"></i>Add Image</button>
		<br>
		  <button class="dltimg color">
	...
	<div class="carousel-item">
	  <img class="d-block w-100" src="im5.jpg" alt="Dancing Group">
	<div class="carousel-caption">
	  <button class="addimg color"><i class="fa fa-plus"></i>Add Image</button>
	  <br>
	  <button class="dltimg color">
  ...
  <div class="carousel-item">
	<img class="d-block w-100" src="im4.jpg" alt="DJ">
  <div class="carousel-caption">
	<button class="addimg color"><i class="fa fa-plus"></i>Add Image</button>
	<br>
	<button class="dltimg color">
           ...
           <div class="popup-img">
            <div class="container">
              ...
              <div class="popup-1" id="popup1">
                ...
                <div class="popup-inner-img">
                <?php include 'include/add_img_div2.php'; ?>
                 <a href="#" class="popup-close">X</a>
                  </div>
...
<br>
  ...
  <form action="include/new_pack_handler.php" method="post"> 
<!--Description text-->
<div class="des-right">
  ...
  <!-- <button class="Editbtn-1">E D I T</button>-->
</div>
</div>
 </div>
</div>
...
<!--Services included in the package -->
  ...
  <p class="pkg">PACKAGE INCLUDES </p>
    <div class="texteditor">
      <textarea name="Pkgincludes"></textarea>
  ...
  <!--    <script  src="ckeditor/ckeditor.js"></script>
   ...
   <!-- <button class="Editbtn-2">E D I T</button>-->
...
<div class ="popup-whole">
  ...
  <a href="#" class="buttons">
    <button class="btn-hover color-2" name="publish">Save All</button>
  </a>
